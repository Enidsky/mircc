...
namespace ns3
{
    ...
    main(int argc, char *argv[])
    {
        ...
        ndn::L3RateTracer::InstallAll("dsccp3-2_throughput.txt", Seconds(0.1));
        ndn::AppDelayTracer::InstallAll("dsccp3-2_delay.txt");
        L2RateTracer::InstallAll("dsccp3-2_drop.txt", Seconds(0.1));
        Simulator::Run();
        Simulator::Destroy();
