...
namespace ns3
{
    ...
    main(int argc, char *argv[])
    {
        ...
        ndn::L3RateTracer::InstallAll("dsccp5_throughput-0.1.txt", Seconds(0.1));
        ndn::AppDelayTracer::InstallAll("dsccp5_delay-0.1.txt");
        L2RateTracer::InstallAll("dsccp5_drop-0.1.txt", Seconds(0.1));
        Simulator::Run();
        Simulator::Destroy();
